    ...
    return (
      <div className="w-40 h-40 flex items-center justify-center">
        <svg width={160} height={160} viewBox="0 0 160 160">
          <circle cx={centerX} cy={centerY} r={radius} fill="none" stroke="#374151" strokeWidth="0" />
  ...
  return (
    <div>
      <svg width={160} height={170} viewBox="0 0 160 160">
        <circle cx={centerX} cy={centerY} r={radius} fill="none" stroke="#fff" strokeWidth="0" />
        {data.map((item, index) => {
        ...
        <circle cx={centerX} cy={centerY} r={innerRadius} fill="none" stroke="#ffffff" strokeWidth="0" />
      </svg>
    </div>
  )
}
